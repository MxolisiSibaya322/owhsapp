    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child : Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [
          ...
          Image.asset("assets/images/badge.png",width: 400,height: 400,),
          Row(
          ...
          children: [
            ElevatedButton(
              ...
              child: const Text(selectionColor : Colors.white,'Login'),
            ),
            ...
            ElevatedButton(
              ...
              child: const Text(selectionColor : Colors.white,'Sign Up'),
            ),
          ],
        )
        ],)
